...
project = u'Radiuss Spack Testing'
...
latex_documents = [
    (master_doc, 'RADIUSS_CI.tex', u'RADIUSS CI Documentation',
...
man_pages = [
    (master_doc, 'RADIUSS_CI', u'RADIUSS CI Documentation',
     [author], 1)
]
